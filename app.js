   ...
   var Income = function(id,description,value){
    ...
    return{
        ...
        calculateBudget:function(){
            ...
            // calculate toal incomes and expenses
            ...
            //culculate the percentage of the incomes that we spent
...
var UIController=(function(){
    ...
    return{
        ...
        addListItem:function(obj, type){
            ...
            //Remplace the placeholder text with some actuel data
        ...
        displayMonth: function(){
            ...
            now = new Date();
            months=['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'Octor', 'November','December'];
            month=now.getMonth();
...
var controller=(function(bugdetCtrl,UICtrl){
    ...
    var ctrlAddItem=function(){
        ...
        newItem=bugdetCtrl.addItems(input.type, input.description, input.value);
